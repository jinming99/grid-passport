...
| `explainer/` | planned (#13) | natural-language prose only; never writes structured fields | `ProjectedView` + `Role` (never raw `CaseInput`) | §3.4 write-scope dual: read-scope contract |
