...
POLICY: dict[str, PolicyEntry] = {
    ...
    "request.customerContact": PolicyEntry("public", _ALL, "Customer contact", ""),
    "request.loadType": PolicyEntry("public", _ALL, "Load type", ""),
    "request.connectionVoltageKV": PolicyEntry("public", _ALL, "Connection voltage (kV)", ""),
    "request.netMetered": PolicyEntry("public", _ALL, "Net-metered", ""),
