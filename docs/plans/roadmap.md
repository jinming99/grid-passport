...
**Steps.**
1. Add `apps/desktop/` workspace with Tauri scaffold (Tauri 2.x; Rust core + Next.js frontend). Uses the `developing-tauri-plugins` skill for permissions/config guidance.
